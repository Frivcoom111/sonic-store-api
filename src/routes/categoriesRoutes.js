...
routes.post("/create", authToken, authAdminOnly, categoriesControllers.createCategory.bind(categoriesControllers));
routes.patch("/update/:id", authToken, authAdminOnly, categoriesControllers.updatedCategory.bind(categoriesControllers));
routes.delete("/delete/:id", authToken, authAdminOnly, categoriesControllers.deleteCategory.bind(categoriesControllers));
